  ...
  const signTransaction = useCallback(async () => {
    ...
    if (!response) {
      ...
      try {
        ...
        console.log(
          "Verified message: ",
          wallet?.address === publicKey.toSuiAddress()
        );
        console.log(
          "Visit https://github.com/EthosWallet/ethos-example-app/blob/main/components/SignTransaction.tsx#L30 for more details."
        );
    ...
    <div className="flex flex-col gap-6">
      ...
      {signError && (
        <ErrorMessage reset={reset}>
          Signing did not work. See the developer console for additional
          information.
        </ErrorMessage>
      )}
      <button
